...
const Banner = () => {
  return (
    ...
    <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row   my-10 '>
       ...
       <p className='text-xl font-semibold'><span className='italic font-bold'>"Welcome to our learning platform ,where knowledege meets curiosity!!</span> Explore a wide range of courses designed to help you achieve your goals and gow everyday"</p>
