...
const Signup = () => {
  ...
  return (
    <div className="w-full sm:w-3/4 md:w-2/4 lg:w-1/3 mx-auto mt-20 p-6 border-2  bg-gray-700 text-slate-300 rounded-lg ">
      <Link
        to="/"
      ...
      <div className=" text-center font-bold text-white">
        {" "}
        <h1 className="text-3xl mt-2  ">Register User</h1>
      </div>
